             ...
             <div class="row">
                <div class="col-md-12">
                    <div class="card mb-10">
                        <div class="card-body">
                        <form method="POST" class = "main-form" enctype="multipart/form-data" action="{{ url('editpurchase') }}">
                                {{ csrf_field() }}
                                <div class="form-group row">
                                    <input type="hidden" id="method" name="_method" value="PUT">
                                    <input type="hidden" id="purchase_id" name="purchase_id" value={{ $purchases['purchase_id'] }}>
                                    <input type="hidden" id="po_product_id" name="po_product_id" value={{ $purchases['po_product_id'] }}>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text"  name ="purchase_code" value={{ $purchases['purchase_code'] }} class="form-control" id="inputpurchase_code" placeholder="รายการเลขที่" readonly="readonly">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputpurchase_date" class="col-sm-2 col-form-label">วันที่ทำรายการ</label>
                                    <div class="col-sm-4">
                                        <input type="date" name='purchase_date'value={{ $purchases['purchase_date'] }} class="form-control" id="date" name="date">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputpurchase_reference" class="col-sm-2 col-form-label">อ้างอิง</label>
                                    <div class="col-sm-4">
                                        <input type="text"  name ="purchase_reference"  value={{ $purchases['purchase_reference'] }} class="form-control" id="inputpurchase_reference" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="hidden"  name ="customer_id"  value='{{ $purchases['customer_id'] }}'  class="form-control" id="inputcustomer_id" >
                                        <input type="text"  name ="customer_name" value='{{ $purchases['customer_name'] }}' class="form-control" id="inputcustomer_name" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputcustomer_detail" class="col-sm-2 col-form-label">รายละเอียดลูกค้า</label>
                                    <div class="col-sm-4">
                                        <textarea class="form-control" rows = "5" cols = "50" name = "customer_detail" id="inputcustomer_detail">{{ $purchases['customer_detail'] }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="product-list form-group row">
                                    <label for="inputselect_modal" class="col-sm-1 col-form-label"> <a id ="select-product" data-toggle="modal"  href="#selectproduct"><i class="i-Cursor-Select"></i></a>รหัสสินค้า</label>
                                        <input type="hidden"  name ="product_id" value={{ $purchases['product_id'] }} class="form-control" id="inputproduct_id" >
                                    <div class="col-sm-1">
                                        <input type="text"  name ="product_code" value={{ $purchases['product_code'] }} class="form-control" id="inputproduct_code" placeholder="รหัสสินค้า" >
                                    </div>
                                    <label for="inputproduct_name" class="col-sm-1 col-form-label">ชื่อสินค้า</label>
                                    <div class="col-sm-2">
                                        <input type="text"  name ="product_name"  value={{ $purchases['product_name'] }} class="form-control" id="inputproduct_name" placeholder="ชื่อสินค้า" >
                                    </div>
                                    <label for="inputproduct_number" class="col-sm-1 col-form-label">จำนวน</label>
                                    <div class="col-sm-1">
                                        <input type="text"  name ="product_number" value={{ $purchases['product_number'] }} class="form-control" id="inputproduct_number" >
                                    </div>
                                    <label for="inputproduct_price_buy" class="col-sm-1 col-form-label">มูลค่าต่อหน่วย</label>
                                    <div class="col-sm-1">
                                        <input type="text"  name ="product_price_buy" value={{ $purchases['product_price_buy'] }} class="form-control" id="inputproduct_buy" >
                                    </div>
                                    <label for="inputproduct_total" class="col-sm-1 col-form-label">รวม</label>
                                    <div class="col-sm-2">
                                        <input type="text"  name ="product_total"  value={{ $purchases['product_total'] }} class="form-control" id="inputproduct_total" placeholder="รวม" >
                                    </div>
                                </div>
                                ...
                                {{-- <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <label class="radio radio-primary">
                                            <input type="radio" name="purchase_status_tranfer" value="0" formControlName="radio"  @if( $purchases['purchase_status_tranfer'] == 0)checked @endif>
                                            <span>รอโอนสินค้า</span>
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="radio radio-primary">
                                            <input type="radio" name="purchase_status_tranfer" value="1" formControlName="radio" @if( $purchases['purchase_status_tranfer'] == 1)checked @endif>
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control"  name ="stock_place_id" id="inputstock_place_id">
                                                    ...
                                                    @foreach ($stock_places as $stock)
                                                        @if ($stock['stock_place_id'] == $purchases['purchase_stock'])
