                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="ul-purchase-detail-purchase-code mb-4 d-flex align-items-baseline">
                                            ...
                                            <h5 class="font-weight-200 text-primary mb-0 mr-2">{{ $purchases['purchase_code'] }}</h5>
                                        </div>
                                        <div class="ul-purchase-detail-purchase-type mb-4 d-flex align-items-baseline">
                                            ...
                                            <h5 class="font-weight-200 text-primary mb-0 mr-2">ซื้อสินค้าเข้า</h5>
                                        </div>
                                        <div class="ul-purchase-detail-purchase-date mb-4 d-flex align-items-baseline">
                                            ...
                                            <h5 class="font-weight-200 text-primary mb-0 mr-2">{{ $purchases['purchase_date'] }}</h5>
                                        </div>
                                        <div class="ul-purchase-detail-purchase-date mb-4 d-flex align-items-baseline">
                                            <h4 class="font-weight-400 text-primary mb-0 mr-2">อ้างอิง</h4>
                                            <h5 class="font-weight-200 text-primary mb-0 mr-2">{{ $purchases['purchase_reference'] }}</h5>
                                        </div>
                                            ...
                                            <div class="ul-product-detail__brand-name mb-4">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" x-placement="bottom-start">
                                                        <a class="dropdown-item" href="/editpurchase/{{ $purchases['purchase_id'] }}">แก้ไข</a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                            ...
                            <div class="">
                                <div class="table-responsive">
                                    <table id="user_table" class="table  text-center">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>{{ $purchases['product_code'] }}</td>
                                                <td><a href="/product/{{ $purchases['product_id'] }}">{{ $purchases['product_name'] }}</a></td>
                                                <td>{{ $purchases['product_number'] }}</td>
                                                <td>{{ $purchases['product_total'] }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
