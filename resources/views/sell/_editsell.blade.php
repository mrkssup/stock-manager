                    ...
                    <div class="card mb-10">
                        ...
                        <form method="POST" class = "main-form" enctype="multipart/form-data" action="{{ url('editsell') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="hidden"  name ="customer_id"  value='{{ $sells['customer_id'] }}'  class="form-control" id="inputcustomer_id" >
                                        <input type="text"  name ="customer_name" value='{{ $sells['customer_name'] }}' class="form-control" id="inputcustomer_name" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputcustomer_detail" class="col-sm-2 col-form-label">รายละเอียดลูกค้า</label>
                                    <div class="col-sm-4">
                                        <textarea class="form-control" rows = "5" cols = "50" name = "customer_detail" id="inputcustomer_detail">{{ $sells['customer_detail'] }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
