             ...
             <div class="row">
                <div class="col-md-12">
                    <div class="card mb-10">
                        <div class="card-body">
                        <form method="POST" class = "main-form" enctype="multipart/form-data" action="{{ url('postsell') }}">
                                {{ csrf_field() }}
                                <div class="form-group row">
                                    <label for="inputsell_type" class="col-sm-2 col-form-label">ประเภท</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text"  name ="sell_code" value={{ $sell_code['sell_code'] }} class="form-control" id="inputsell_code" placeholder="รายการเลขที่" readonly="readonly">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputpurchase_date" class="col-sm-2 col-form-label">วันที่ทำรายการ</label>
                                    <div class="col-sm-4">
                                        <input type="date" name='sell_date'value={{ $today['today'] }} class="form-control" id="date" name="date">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputsell_reference" class="col-sm-2 col-form-label">อ้างอิง</label>
                                    <div class="col-sm-4">
                                        <input type="text"  name ="sell_reference" class="form-control" id="inputsell_reference" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="product-list form-group row">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="text"  name ="product_price_sell" @if( !empty($get_product['product_price_sell'])) value={{ $get_product['product_price_sell'] }} @endif  class="form-control" id="inputproduct_sell" >
                                    </div>
                                ...
                                {{-- <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <label class="radio radio-primary">
                                            <input type="radio" name="sell_status" value="0" formControlName="radio">
                                            <span>รอโอนสินค้า</span>
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="radio radio-primary">
                                            <input type="radio" name="sell_status" value="1" formControlName="radio">
