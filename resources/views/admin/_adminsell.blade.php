            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="md-form active-cyan">
                        <form method="POST" action="{{ url('searchadminsell') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="col-md-12">
                            <div class="card o-hidden mb-4">
                                <div class="card-header d-flex align-items-center border-0">
                                    <h3 class="w-50 float-left card-title m-0">รายการขายรอดำเนินการ</h3>
                                        ...
                                        <table id="adminsell_table" class="table  text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                        ...
                                                        <td>{{ $sell['product_number'] }}</td>
                                                        <td>{{ $sell['full_name'] }}</td>
                                                        <td>{{ $sell['stock_place_name'] }}</td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu" x-placement="bottom-start">
                                                                    <a class="dropdown-item" href="/admin/shipping/{{ $sell['sell_id'] }}">จัดส่งสินค้า</a></i>
